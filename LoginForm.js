        ...
        <View style={styles.screen}>
            <SafeAreaView style={styles.screen}>
                ...
                <View style={{ height:'30%', width:'80%', marginHorizontal:'10%', alignItems:'center'}}>
                    <Headline style={{color:'#e0e0e0', fontSize:15}}>Buy, Sell & Recieve 100 of Cryptocoins.</Headline>
                    ...
                    <Button color="#eeeeee" mode="outlined" onPress={loginHandler}>LOGIN</Button>
                    <Button color="#eeeeee" mode="outlined" onPress={() => props.navigation.navigate('SignUp')}>JOIN OUR PLATFORM</Button>
                </View>
